...
public class InvoiceRepositoryAddLineItemsTest {
	...
	public void testAddLineItems() {
		...
		assertThat(getFromDbInvoice).isEqualTo(saveInDbInvoice);
		assertThat(getFromDbInvoice.getLineItems()).isEqualTo(saveInDbInvoice.getLineItems());
	}
