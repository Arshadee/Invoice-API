...
public class InvoiceRepositoryTotalTest {
	...
	public void testTotalAmount() {
		...
		BigDecimal expectedVatTotal = getExpectedVatTotal(expectedSubTotal, vatRate);
		BigDecimal expectedTotal = getExpectedTotal(expectedSubTotal,expectedVatTotal);
		...
		BigDecimal totalfromDb = getFromDbInvoice.getTotal();
		
		assertThat(totalfromDb).isEqualTo(expectedTotal);		
