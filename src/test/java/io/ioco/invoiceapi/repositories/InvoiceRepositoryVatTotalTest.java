...
public class InvoiceRepositoryVatTotalTest {
	...
	@Test
	public void testVatTotalAmount() {
		...
		BigDecimal vatTotalfromDb = getFromDbInvoice.getVat();
		assertThat(vatTotalfromDb).isEqualTo(expectedVatTotal);		
	}
